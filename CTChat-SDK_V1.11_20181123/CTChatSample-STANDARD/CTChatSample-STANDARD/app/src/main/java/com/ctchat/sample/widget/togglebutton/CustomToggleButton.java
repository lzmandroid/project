package com.ctchat.sample.widget.togglebutton;
...
import com.ctchat.sample.widget.togglebutton.rebound.SimpleSpringListener;
import com.ctchat.sample.widget.togglebutton.rebound.Spring;
import com.ctchat.sample.widget.togglebutton.rebound.SpringConfig;
import com.ctchat.sample.widget.togglebutton.rebound.SpringSystem;
import com.ctchat.sample.widget.togglebutton.rebound.SpringUtil;
...
public class CustomToggleButton extends View {
     ...
     * 开启颜色
     */
    private int onColor = Color.parseColor("#1aa4fc");
    /**
     * 关闭颜色
     */
     ...
     * 边框大小
     */
    private int toggleBorderWidth = 2;
    /**
     * 垂直中心
     */
    ...
    public void setup(AttributeSet attrs) {
        ...
        toggleBorderWidth = typedArray.getDimensionPixelSize(R.styleable.CustomToggleButton_toggleBorderWidth, toggleBorderWidth);
    ...
    protected void onLayout(boolean changed, int left, int top, int right,
        ...
        startX = radius;
        endX = width - radius;
        spotMinX = startX + toggleBorderWidth;
        spotMaxX = endX - toggleBorderWidth;
        spotSize = height - 4 * toggleBorderWidth;
